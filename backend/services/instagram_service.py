...
class InstagramDataService:
    ...
    def get_full_profile(self, username: str) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "profile_pic_hash_method": "sha256_downloaded_bytes",
                ...
                "account_country_region": None,
                "former_usernames": None,
                "active_ads": None,
                "linked_facebook_account": getattr(profile, "connected_fb_page", None),
                "story_highlights": None,
                "reels_igtv_count": None,
                "recent_posts": posts,
    ...
    def _build_private_profile(
        ...
        return {
            ...
            "external_url": profile.external_url,
            "external_urls": [],
            "linkedin_profile_link_in_bio": None,
            "professional_email_in_bio": None,
            "contact_email": None,
            "contact_phone": None,
            ...
            "recent_posts": [],
            "last_12_posts_captions": [],
            "post_hashtags": [],
            "post_timestamps": [],
            "post_location_tags": [],
            "tagged_users_in_posts": [],
            "mentioned_users_in_captions": [],
            "tagged_photos": None,
            "comments_made_by_subject": None,
            "pinned_posts": [],
            "collab_posts": [],
